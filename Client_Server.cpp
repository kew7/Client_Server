...
// Client_Server.cpp : Defines the class behaviors for the application.
//
...
BOOL CClientServerApp::InitInstance()
{
	...
	else if (nResponse == IDCANCEL)
	{
		...
		//  dismissed with Cancel
		 if (WSACleanup() == SOCKET_ERROR)   // выгружаем библиотеку при закрытии окна
					MessageBox(0, "Ошибка выгрузки сокета", 0, 0);
	}
	else if (nResponse == -1)
	{
